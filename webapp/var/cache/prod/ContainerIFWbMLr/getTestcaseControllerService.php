...
include_once \dirname(__DIR__, 4).'/src/Controller/API/TestcaseController.php';
...
$instance->setContainer(($this->privates['.service_locator.lGiLGIf'] ?? $this->load('get_ServiceLocator_LGiLGIfService.php'))->withContext('App\\Controller\\API\\TestcaseController', $this));

...
$this->services['App\\Controller\\Jury\\PrintController'] = $instance = new \App\Controller\Jury\PrintController(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\DOMJudgeService'] ?? $this->getDOMJudgeServiceService()), ($this->services['App\\Service\\ConfigurationService'] ?? $this->getConfigurationServiceService()));

$instance->setContainer(($this->privates['.service_locator.LNRNTgI'] ?? $this->load('get_ServiceLocator_LNRNTgIService.php'))->withContext('App\\Controller\\Jury\\PrintController', $this));

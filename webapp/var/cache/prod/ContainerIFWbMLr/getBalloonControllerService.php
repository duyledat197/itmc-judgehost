...
// Returns the public 'App\Controller\API\BalloonController' shared autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Controller/API/BalloonController.php';

$this->services['App\\Controller\\API\\BalloonController'] = $instance = new \App\Controller\API\BalloonController(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\DOMJudgeService'] ?? $this->getDOMJudgeServiceService()), ($this->services['App\\Service\\ConfigurationService'] ?? $this->getConfigurationServiceService()), ($this->privates['App\\Service\\EventLogService'] ?? $this->getEventLogServiceService()));

$instance->setContainer(($this->privates['.service_locator.lGiLGIf'] ?? $this->load('get_ServiceLocator_LGiLGIfService.php'))->withContext('App\\Controller\\API\\BalloonController', $this));

...
// Returns the public 'App\Controller\API\LanguageController' shared autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Controller/API/LanguageController.php';

$this->services['App\\Controller\\API\\LanguageController'] = $instance = new \App\Controller\API\LanguageController(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\DOMJudgeService'] ?? $this->getDOMJudgeServiceService()), ($this->services['App\\Service\\ConfigurationService'] ?? $this->getConfigurationServiceService()), ($this->privates['App\\Service\\EventLogService'] ?? $this->getEventLogServiceService()));

$instance->setContainer(($this->privates['.service_locator.lGiLGIf'] ?? $this->load('get_ServiceLocator_LGiLGIfService.php'))->withContext('App\\Controller\\API\\LanguageController', $this));

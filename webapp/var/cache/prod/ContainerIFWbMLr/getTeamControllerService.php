...
$instance->setContainer(($this->privates['.service_locator.lGiLGIf'] ?? $this->load('get_ServiceLocator_LGiLGIfService.php'))->withContext('App\\Controller\\API\\TeamController', $this));

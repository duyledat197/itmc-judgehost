...
include_once \dirname(__DIR__, 4).'/src/Controller/Jury/JudgehostRestrictionController.php';
...
$instance->setContainer(($this->privates['.service_locator.LNRNTgI'] ?? $this->load('get_ServiceLocator_LNRNTgIService.php'))->withContext('App\\Controller\\Jury\\JudgehostRestrictionController', $this));
